...
from quant.fundamental_data.fundamental_importer import FundamentalCSVImporter
from quant.fundamental_data.fundamental_models import normalize_statement
from quant.fundamental_data.fundamental_quality import FundamentalQualityAnalyzer
...
class FundamentalService:
    ...
    def coverage(self, symbols: list[str], parameters: dict | None = None) -> dict:
