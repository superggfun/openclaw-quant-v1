...
class FactorPipeline:
    ...
    def run(
        ...
        return FactorPipelineResult(
            ...
            cleaned_factor_values=result.cleaned_factor_values,
            ...
            before_summary_statistics=result.before_summary_statistics,
            after_summary_statistics=result.after_summary_statistics,
            sector_neutralization_result=result.sector_neutralization_result,
    ...
    def _write_report(self, result: FactorPipelineResult) -> Path:
        ...
        path = self.report_dir / f"factor_pipeline_{timestamp}.json"
