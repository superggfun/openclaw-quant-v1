...
from quant.risk.risk_engine import DEFAULT_INDUSTRY_MAP, RiskEngine
...
class OptimizerEngine:
    ...
    def optimize(
        ...
        return OptimizerResult(
            ...
            risk_score_before=result.risk_score_before,
            estimated_risk_score_after=result.estimated_risk_score_after,
    ...
    def _write_report(self, result: OptimizerResult) -> Path:
        ...
        path = self.report_dir / f"optimize_{timestamp}.json"
    ...
    def _write_targets(allocation: dict[str, float], path: str | Path) -> Path:
        ...
        target_path.write_text(json.dumps(allocation, indent=2) + "\n", encoding="utf-8")
        return target_path
