...
`v0.40.0` deliberately stops at measurement. Future performance work must preserve no-lookahead behavior, report schemas, factor semantics, backtest semantics, and validation behavior.
